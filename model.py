...
#from tesorflow.contrib.legacy_seq2seq.python.ops import seq2seq
import numpy as np
...
class Model():
    def __init__(self, args, infer=False): # infer is set to true during sampling.
        ...
        outputs, self.final_state = tf.contrib.legacy_seq2seq.rnn_decoder(inputs,self.initial_state, cell, loop_function=loop if infer else None, scope='rnnlm')
